    ...
    class GarageMenagement
    {
        ...
        public void InsertVichle()
        {
            try
            {
                ...
                Vehicle vichle = Factory.ChoosingVichle(choice);
        ...
        public void inflateVehicleTires()
        {
            ...
            if (garageManager.IsLicensePlateExists(Licence))
            {
                Vehicle.GetExistingLicensePlates(Licence);
                garageManager.AddAirVehicleWheels(Licence);
            }
            else 
            {
        ...
        public void refuelVehicle()
        {
            Console.WriteLine("Please Enter Licence number:");
            string Licence = Console.ReadLine();
            if (garageManager.IsLicensePlateExists(Licence))// && eEngineType == 0)
            {
                eFuelType FuelChoice = GetFuelType();
                Console.WriteLine("Enter Amount:");
                float amount = float.Parse(Console.ReadLine());
                //DriveByFuel.PutFuel(amount,FuelChoice);
        ...
        public eFuelType GetFuelType()
        {
            ...
            int FuelChoice = Factory.GetValidChoice(1, 4);
