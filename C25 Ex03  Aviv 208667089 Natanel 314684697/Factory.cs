...
namespace Ex03.ConsoleUI
{
    internal class Factory
    {
        ...
        public static Vehicle ChoosingVichle(string choice)
        {
        ...
        private static Vehicle CreateElectricMotorcycle()
        {
        ...
        private static Vehicle CreateFuelMotorcycle()
        {
        ...
        private static Vehicle CreatePrivateCar()
        {
        ...
        private static Vehicle CreateElectricCar()
        {
        ...
        private static void setCommonVehicleProperties(Vehicle i_vehicle)
        {
        ...
        private static List<Wheel> getWheelsInput(Vehicle i_Vehicle)
        {
